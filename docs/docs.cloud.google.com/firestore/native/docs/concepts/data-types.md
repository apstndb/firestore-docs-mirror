---
name: documents/docs.cloud.google.com/firestore/native/docs/concepts/data-types
uri: https://docs.cloud.google.com/firestore/native/docs/concepts/data-types
