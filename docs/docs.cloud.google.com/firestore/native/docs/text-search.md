---
name: documents/docs.cloud.google.com/firestore/native/docs/text-search
uri: https://docs.cloud.google.com/firestore/native/docs/text-search
title: Use text search
