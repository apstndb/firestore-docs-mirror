---
name: documents/docs.cloud.google.com/firestore/native/docs/solutions/role-based-access
uri: https://docs.cloud.google.com/firestore/native/docs/solutions/role-based-access
title: Secure data access for users and groups
