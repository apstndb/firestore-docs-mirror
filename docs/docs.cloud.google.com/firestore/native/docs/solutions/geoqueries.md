---
name: documents/docs.cloud.google.com/firestore/native/docs/solutions/geoqueries
uri: https://docs.cloud.google.com/firestore/native/docs/solutions/geoqueries
title: Geo queries
...
We can use Geohashes to store and query documents by position in Firestore with reasonable efficiency while only requiring a single indexed field.
