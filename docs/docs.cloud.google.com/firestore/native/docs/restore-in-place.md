...
This page describes how to restore data in a backup to a database with the same name as the source database of the backup. Before you read this page, you should be familiar with [Back up and restore data](/firestore/native/docs/backups) .
...
## What's next
  ...
  - [Learn more about backup schedules and restore operations](/firestore/native/docs/backups)
  - [Learn about configuring point-in-time recovery (PITR)](/firestore/native/docs/pitr)
