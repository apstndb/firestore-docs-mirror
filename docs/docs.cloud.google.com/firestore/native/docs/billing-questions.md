---
name: documents/docs.cloud.google.com/firestore/native/docs/billing-questions
uri: https://docs.cloud.google.com/firestore/native/docs/billing-questions
title: Understanding your billing report
