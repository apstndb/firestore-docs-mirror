...
description: Only allow the creation and updating of databases with App Engine Integration Mode enabled.</code></pre></td>
</tr>
<tr class="odd">
...
description: Only allow the creation and updating of databases with Standard Edition.</code></pre></td>
</tr>
</tbody>
</table>
