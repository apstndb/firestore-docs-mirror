---
name: documents/docs.cloud.google.com/firestore/native/docs/standard-indexing
uri: https://docs.cloud.google.com/firestore/native/docs/standard-indexing
title: Manage Standard edition indexes
