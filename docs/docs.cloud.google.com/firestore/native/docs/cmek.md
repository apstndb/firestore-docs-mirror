...
You can also view the key versions that are being used to protect a database. For more information, see [View the key in use](https://docs.cloud.google.com/firestore/native/docs/use-cmek#view-key) .
...
For more information about Firestore backups, see [Back up and restore data](https://docs.cloud.google.com/firestore/native/docs/backups) .
