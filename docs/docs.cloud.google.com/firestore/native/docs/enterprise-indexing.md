---
name: documents/docs.cloud.google.com/firestore/native/docs/enterprise-indexing
uri: https://docs.cloud.google.com/firestore/native/docs/enterprise-indexing
title: Manage Enterprise edition indexes
