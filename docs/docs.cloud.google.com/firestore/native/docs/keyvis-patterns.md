---
name: documents/docs.cloud.google.com/firestore/native/docs/keyvis-patterns
uri: https://docs.cloud.google.com/firestore/native/docs/keyvis-patterns
title: Heatmap patterns for document keys
