---
name: documents/docs.cloud.google.com/firestore/native/docs/audit-logging
uri: https://docs.cloud.google.com/firestore/native/docs/audit-logging
title: Firestore audit logging information
