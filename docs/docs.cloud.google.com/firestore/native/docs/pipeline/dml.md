---
name: documents/docs.cloud.google.com/firestore/native/docs/pipeline/dml
uri: https://docs.cloud.google.com/firestore/native/docs/pipeline/dml
title: Modify data with Pipeline operations
