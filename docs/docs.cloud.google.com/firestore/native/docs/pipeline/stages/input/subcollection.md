---
name: documents/docs.cloud.google.com/firestore/native/docs/pipeline/stages/input/subcollection
uri: https://docs.cloud.google.com/firestore/native/docs/pipeline/stages/input/subcollection
