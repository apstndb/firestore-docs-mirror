---
name: documents/docs.cloud.google.com/firestore/native/docs/pipeline/stages/input/literals
uri: https://docs.cloud.google.com/firestore/native/docs/pipeline/stages/input/literals
title: Literals (Input Stage)
description: Describes how to use the literals stage in Firestore Pipeline Operations. Covers returning documents from a fixed set of predefined document objects.
