---
name: documents/docs.cloud.google.com/firestore/native/docs/pipeline/stages/output/update
uri: https://docs.cloud.google.com/firestore/native/docs/pipeline/stages/output/update
title: Update (Output Stage)
