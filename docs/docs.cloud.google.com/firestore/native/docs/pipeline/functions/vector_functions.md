---
name: documents/docs.cloud.google.com/firestore/native/docs/pipeline/functions/vector_functions
uri: https://docs.cloud.google.com/firestore/native/docs/pipeline/functions/vector_functions
title: Vector Functions Reference
description: Explains how to use vector functions like COSINE_DISTANCE, DOT_PRODUCT, and EUCLIDEAN_DISTANCE in Firestore Pipeline operations.
