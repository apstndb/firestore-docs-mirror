...
The [Firestore data model](https://docs.cloud.google.com/firestore/docs/data-model) consists of collections that contain documents. A document contains a set of key-value pairs.
...
See [examples](https://docs.cloud.google.com/firestore/native/docs/extend-with-cloud-run-functions#examples) for how to use Firestore in Native Mode events to trigger a Cloud Run function.
