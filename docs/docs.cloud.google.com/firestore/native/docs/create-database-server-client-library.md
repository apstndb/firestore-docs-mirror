---
name: documents/docs.cloud.google.com/firestore/native/docs/create-database-server-client-library
uri: https://docs.cloud.google.com/firestore/native/docs/create-database-server-client-library
