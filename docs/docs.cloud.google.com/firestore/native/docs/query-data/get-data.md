---
name: documents/docs.cloud.google.com/firestore/native/docs/query-data/get-data
uri: https://docs.cloud.google.com/firestore/native/docs/query-data/get-data
title: Getting data
...
Follow one of the [Firestore quickstarts](https://docs.cloud.google.com/firestore/docs/quickstarts) to create a Firestore database.
