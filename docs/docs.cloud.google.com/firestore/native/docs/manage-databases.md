...
Use delete protection to prevent accidental deletion of a database. You cannot delete a database with delete protection enabled until you disable delete protection. Delete protection is disabled by default. You can update the database configuration to [enable or disable delete protection](https://docs.cloud.google.com/firestore/native/docs/manage-databases#update-dp) .

## Set up Firestore Security Rules for your databases

Use the Firebase CLI to deploy Firestore Security Rules to each of your databases. Refer to the [guide for managing and deploying Firestore Security Rules](https://firebase.google.com/docs/rules/manage-deploy) .
...
If the database has the delete protection setting enabled, you must first [disable delete protection](https://docs.cloud.google.com/firestore/native/docs/manage-databases#update-dp) .
...
Deleting a database does not automatically delete any [Eventarc triggers](https://docs.cloud.google.com/firestore/native/docs/eventarc) for that database. The trigger stops delivering events but continues to exist until you [delete the trigger](https://cloud.google.com/eventarc/docs/managing-triggers#trigger-delete) .
...
## What's next
  ...
  - [Add data](https://docs.cloud.google.com/firestore/native/docs/manage-data/add-data)
  - [Get data](https://docs.cloud.google.com/firestore/native/docs/query-data/get-data)
  - [Delete data](https://docs.cloud.google.com/firestore/native/docs/manage-data/delete-data)
