...
Use the [`  gcloud firestore databases create  `](https://cloud.google.com/sdk/gcloud/reference/firestore/databases/create) command.
  ...
  - To create a Firestore Enterprise edition database in Native mode:
    ...
    Replace the following:
      ...
      - LOCATION : the name of a [Firestore multi-region or region](/firestore/native/docs/locations#types) .
...
Use the Firebase CLI to deploy Firestore Security Rules to each of your databases. Refer to the [guide for managing and deploying Firestore Security Rules](//firebase.google.com/docs/rules/manage-deploy) .
...
Deleting a database does not automatically delete any [Eventarc triggers](/firestore/native/docs/eventarc) for that database. The trigger stops delivering events but continues to exist until you [delete the trigger](https://cloud.google.com/eventarc/docs/managing-triggers#trigger-delete) .
...
You can clone an existing database at a selected timestamp into a new database:
  ...
  - The timestamp has a granularity of one minute and specifies a point of time in the past, in the period defined by the [PITR window](/firestore/native/docs/pitr#pitr_window) :
      ...
      - You can check the earliest timestamp that you can pick [in your database's description](/firestore/native/docs/use-pitr#get-period) .
...
Replace the following:
  ...
  - PITR\_TIMESTAMP : a [PITR timestamp](/firestore/native/docs/use-pitr#get-period) in the [RFC 3339 format](https://tools.ietf.org/html/rfc3339) , at minute granularity. For example: `  2025-06-01T10:20:00.00Z  ` or `  2025-06-01T10:30:00.00-07:00  ` .
...
## What's next
  ...
  - [Add data](/firestore/native/docs/manage-data/add-data)
  - [Get data](/firestore/native/docs/query-data/get-data)
  - [Delete data](/firestore/native/docs/manage-data/delete-data)
