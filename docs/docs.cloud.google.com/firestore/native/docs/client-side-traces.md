---
name: documents/docs.cloud.google.com/firestore/native/docs/client-side-traces
uri: https://docs.cloud.google.com/firestore/native/docs/client-side-traces
title: Monitor performance with client-side traces
