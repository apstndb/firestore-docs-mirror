---
name: documents/docs.cloud.google.com/firestore/native/docs/security/rules-structure
uri: https://docs.cloud.google.com/firestore/native/docs/security/rules-structure
