---
name: documents/docs.cloud.google.com/firestore/native/docs/security/get-started
uri: https://docs.cloud.google.com/firestore/native/docs/security/get-started
title: Getting started with security rules
