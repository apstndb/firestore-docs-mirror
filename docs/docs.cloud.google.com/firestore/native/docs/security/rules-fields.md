---
name: documents/docs.cloud.google.com/firestore/native/docs/security/rules-fields
uri: https://docs.cloud.google.com/firestore/native/docs/security/rules-fields
title: Control access to specific fields
