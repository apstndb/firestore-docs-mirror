---
name: documents/docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-data
uri: https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-data
title: Migrate to Firestore with MongoDB compatibility
description: Migrate your MongoDB-compatible source database to Firestore with MongoDB compatibility.
