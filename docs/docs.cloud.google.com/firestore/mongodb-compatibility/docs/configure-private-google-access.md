---
name: documents/docs.cloud.google.com/firestore/mongodb-compatibility/docs/configure-private-google-access
uri: https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/configure-private-google-access
title: Configure Private Google Access in Firestore with MongoDB compatibility
description: Configure Private Google Access for Firestore with MongoDB compatibility, including network requirements, DNS, routing, and firewall configurations.
