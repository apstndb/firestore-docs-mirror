...
The following tables include a breakdown of MongoDB 8.0 features supported by Firestore with MongoDB compatibility. For differences in behavior, see [Behavior differences](/firestore/mongodb-compatibility/docs/behavior-differences) .
