...
The following tables include a breakdown of MongoDB 3.6 features supported by Firestore with MongoDB compatibility. For differences in behavior, see [Behavior differences](/firestore/mongodb-compatibility/docs/behavior-differences) .
