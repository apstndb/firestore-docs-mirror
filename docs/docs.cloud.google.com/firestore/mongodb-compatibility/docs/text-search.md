---
name: documents/docs.cloud.google.com/firestore/mongodb-compatibility/docs/text-search
uri: https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/text-search
title: Use text searches
description: Learn how to perform text searches in Firestore with MongoDB compatibility.
