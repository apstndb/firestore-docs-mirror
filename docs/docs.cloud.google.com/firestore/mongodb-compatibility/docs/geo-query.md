---
name: documents/docs.cloud.google.com/firestore/mongodb-compatibility/docs/geo-query
uri: https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/geo-query
title: Use geo queries
description: Learn how to perform geo queries in Firestore with MongoDB compatibility.
