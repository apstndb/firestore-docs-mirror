...
When you create a database, you must select a [single regional location](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/locations#location-r) or a [multi-region location](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/locations#location-mr) .
...
For more information about the locations of a region, see [Firestore locations](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/locations) .
