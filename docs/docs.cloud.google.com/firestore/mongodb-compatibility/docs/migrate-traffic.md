---
name: documents/docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-traffic
uri: https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-traffic
title: Migrate traffic to Firestore
description: Migrate traffic to Firestore with MongoDB compatibility.
