...
This example assumes you have already [configured SSH connectivity](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-configure-env-vars#mongodb-over-ssh) to your private network, either directly to the machine hosting the MongoDB compatible server, or through a [Bastion](https://cloud.google.com/solutions/connecting-securely#bastion) host.
...
This example assumes you have obtained the parameters and certificates required for [Amazon DocumentDB connectivity](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-configure-env-vars#amazon-documentdb) .
...
Proceed to [Import from the source database](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-import-from-source) .
