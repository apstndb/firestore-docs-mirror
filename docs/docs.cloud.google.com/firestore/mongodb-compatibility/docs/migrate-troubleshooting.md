---
name: documents/docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-troubleshooting
uri: https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-troubleshooting
title: Migration troubleshooting
description: Troubleshoot common issues during data migration to Firestore with MongoDB compatibility.
...
You can verify that processing has stopped by [inspecting Transactional write events](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-traffic#receiving-traffic) and confirming no processing throughput and that no new log entries are being generated.
...
2.  In the tree of nested folders constructed according to the timestamps, expand the folders to see the latest content in the queue. The files could have been sharded and look like the following example:
    ...
    ![Files in DLQ](https://docs.cloud.google.com/static/firestore/mongodb-compatibility/docs/images/firestore-dlq-sharded.png)
...
## What's next
  ...
  - Back to [Migrate to Firestore with MongoDB compatibility](https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/migrate-data) .
