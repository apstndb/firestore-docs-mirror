---
name: documents/docs.cloud.google.com/firestore/mongodb-compatibility/docs/storage-size
uri: https://docs.cloud.google.com/firestore/mongodb-compatibility/docs/storage-size
