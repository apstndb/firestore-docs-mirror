...
The following tables include a breakdown of MongoDB 6.0 features supported by Firestore with MongoDB compatibility. For differences in behavior, see [Behavior differences](/firestore/mongodb-compatibility/docs/behavior-differences) .
...
<tr class="even">
<td><code dir="ltr" translate="no">       $changeStream      </code></td>
<td>No</td>
</tr>
<tr class="odd">
