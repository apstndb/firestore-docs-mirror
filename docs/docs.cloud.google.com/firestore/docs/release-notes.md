...
To learn more, see the [Firestore regional endpoints](/firestore/native/docs/regional-endpoints) guide.

You can also use [Private Service Connect regional endpoints](/vpc/docs/about-accessing-regional-google-apis-endpoints) and [Private Service Connect backends](/vpc/docs/private-service-connect-backends) to connect to the regional and the multi-regional endpoints of the Firestore API.
