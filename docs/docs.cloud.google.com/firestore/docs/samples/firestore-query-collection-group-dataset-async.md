---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-query-collection-group-dataset-async
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-query-collection-group-dataset-async
title: Create a collection of Firestore documents (async)
description: Create a collection of Firestore documents (async).
