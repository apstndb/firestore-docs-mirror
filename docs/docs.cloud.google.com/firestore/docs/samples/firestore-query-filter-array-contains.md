---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-query-filter-array-contains
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-query-filter-array-contains
title: Query a Firestore collection with an array_contains filter
description: Query a Firestore collection with an array_contains filter
