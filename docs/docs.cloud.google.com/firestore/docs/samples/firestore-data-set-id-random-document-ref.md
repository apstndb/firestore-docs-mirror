---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-data-set-id-random-document-ref
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-data-set-id-random-document-ref
title: Create a Firestore document reference with an autogenerated id
description: Create a Firestore document reference with an autogenerated id
