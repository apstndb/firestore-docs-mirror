---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-query-filter-not-eq
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-query-filter-not-eq
title: Query a Firestore collection with a not eq filter
description: Query a Firestore collection with a not eq filter
