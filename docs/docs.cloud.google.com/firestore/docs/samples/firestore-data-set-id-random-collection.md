---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-data-set-id-random-collection
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-data-set-id-random-collection
title: Add a Firestore document using an autogenerated id
description: Add a Firestore document using an autogenerated id
