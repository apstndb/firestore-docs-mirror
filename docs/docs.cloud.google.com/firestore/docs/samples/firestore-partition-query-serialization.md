---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-partition-query-serialization
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-partition-query-serialization
