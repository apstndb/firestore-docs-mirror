---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-query-filter-not-in
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-query-filter-not-in
title: Query a Firestore collection with a not in filter
description: Query a Firestore collection with a not in filter
