---
name: documents/docs.cloud.google.com/firestore/docs/samples/firestore-listen-query-snapshots
uri: https://docs.cloud.google.com/firestore/docs/samples/firestore-listen-query-snapshots
title: Monitor query result changes with Firestore Watch
description: Monitor query result changes with Firestore Watch
