---
name: documents/docs.cloud.google.com/firestore/docs/reference/rpc/google.firestore.v1beta1
uri: https://docs.cloud.google.com/firestore/docs/reference/rpc/google.firestore.v1beta1
title: Package google.firestore.v1beta1
...
The query stages are executed in the following order: 1. from 2. where 3. select 4. order\_by + start\_at + end\_at 5. offset 6. limit 7. find\_nearest
...
Nearest Neighbors search config. The ordering provided by FindNearest supersedes the order\_by stage. If multiple documents have the same vector distance, the returned document order is not guaranteed to be stable between queries.
