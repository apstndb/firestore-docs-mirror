---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/datastore/operations/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/datastore/operations/list
title: gcloud alpha datastore operations list
...
`gcloud alpha datastore operations list` \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` ; default=100\] \[ `  --page-size  ` = `  PAGE_SIZE  ` ; default=100\] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
