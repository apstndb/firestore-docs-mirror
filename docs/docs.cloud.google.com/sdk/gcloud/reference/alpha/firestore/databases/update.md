---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/databases/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/databases/update
title: gcloud alpha firestore databases update
...
gcloud alpha firestore databases update - update the database configuration of a Cloud Firestore database

SYNOPSIS

`gcloud alpha firestore databases update` \[ `  --async  ` \] \[ `  --concurrency-mode  ` = `  CONCURRENCY_MODE  ` \] \[ `  --database  ` = `  DATABASE  ` \] \[ `  --delete-protection  ` \] \[ `  --enable-pitr  ` \] \[ `  --type  ` = `  TYPE  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
