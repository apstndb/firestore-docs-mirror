---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/operations/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/operations/describe
title: gcloud alpha firestore operations describe
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2025-10-17T21:27:10Z"
---
...
`gcloud alpha firestore operations describe` `  NAME  ` \[ `  --database  ` = `  DATABASE  ` ; default="(default)"\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
