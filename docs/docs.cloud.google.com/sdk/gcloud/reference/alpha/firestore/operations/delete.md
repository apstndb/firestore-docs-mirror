---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/operations/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/operations/delete
title: gcloud alpha firestore operations delete
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2025-10-17T21:27:01Z"
---
...
`gcloud alpha firestore operations delete` `  NAME  ` \[ `  --database  ` = `  DATABASE  ` ; default="(default)"\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
