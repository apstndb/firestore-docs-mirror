---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/backups/schedules/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/backups/schedules/delete
title: gcloud alpha firestore backups schedules delete
...
gcloud alpha firestore backups schedules delete - deletes a Cloud Firestore backup schedule

SYNOPSIS

`gcloud alpha firestore backups schedules delete` `  --backup-schedule  ` = `  BACKUP_SCHEDULE  ` `  --database  ` = `  DATABASE  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
