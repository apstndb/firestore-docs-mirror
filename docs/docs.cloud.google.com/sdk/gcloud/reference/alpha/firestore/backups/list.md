---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/backups/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/backups/list
title: gcloud alpha firestore backups list
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2025-10-17T21:26:18Z"
---

NAME

gcloud alpha firestore backups list - list backups available to Cloud Firestore

SYNOPSIS

`gcloud alpha firestore backups list` \[ `  --location  ` = `  LOCATION  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]

EXAMPLES

To list all backups in location us-east1.

    gcloud alpha firestore backups list --location=us-east1 --format="table(name, database, state)"
