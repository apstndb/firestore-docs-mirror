---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/bulk-delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/bulk-delete
title: gcloud alpha firestore bulk-delete
...
`gcloud alpha firestore bulk-delete` \[ `  --async  ` \] \[ `  --collection-ids  ` =\[ `  COLLECTION_GROUP_IDS  ` , …\]\] \[ `  --database  ` = `  DATABASE  ` ; default="(default)"\] \[ `  --namespace-ids  ` =\[ `  NAMESPACE_IDS  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
