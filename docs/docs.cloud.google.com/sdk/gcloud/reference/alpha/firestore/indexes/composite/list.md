---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/indexes/composite/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/indexes/composite/list
title: gcloud alpha firestore indexes composite list
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2026-01-21T20:17:12Z"
---
...
`gcloud alpha firestore indexes composite list` \[ `  --database  ` = `  DATABASE  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command lists composite indexes in the `Events` collection group:
    ...
    gcloud alpha firestore indexes composite list --filter=COLLECTION_GROUP:Events
