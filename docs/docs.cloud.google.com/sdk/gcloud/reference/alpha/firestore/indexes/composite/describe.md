---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/indexes/composite/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/firestore/indexes/composite/describe
title: gcloud alpha firestore indexes composite describe
...
`gcloud alpha firestore indexes composite describe` ( `  INDEX  ` : `  --database  ` = `  DATABASE  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
