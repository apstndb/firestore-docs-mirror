---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/firestore/fields/ttls/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/firestore/fields/ttls/list
title: gcloud firestore fields ttls list
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2026-01-21T20:17:06Z"
---
...
`gcloud firestore fields ttls list` \[ `  --collection-group  ` = `  COLLECTION_GROUP  ` `  --database  ` = `  DATABASE  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
