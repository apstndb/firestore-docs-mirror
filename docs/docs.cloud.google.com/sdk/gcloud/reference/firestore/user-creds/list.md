---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/firestore/user-creds/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/firestore/user-creds/list
title: gcloud firestore user-creds list
...
`gcloud firestore user-creds list` `  --database  ` = `  DATABASE  ` \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
