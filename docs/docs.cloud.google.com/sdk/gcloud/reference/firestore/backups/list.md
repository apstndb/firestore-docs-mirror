---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/firestore/backups/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/firestore/backups/list
title: gcloud firestore backups list
...
`gcloud firestore backups list` \[ `  --location  ` = `  LOCATION  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
