---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/datastore/operations/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/datastore/operations/list
title: gcloud beta datastore operations list
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2025-10-17T21:28:55Z"
---
...
`gcloud beta datastore operations list` \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` ; default=100\] \[ `  --page-size  ` = `  PAGE_SIZE  ` ; default=100\] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To see the list of all export operations, run:
    ...
    gcloud beta datastore operations list --filter='type:export_entities'

To see the list of all export operations for kind 'MyKind', run:

    gcloud beta datastore operations list --filter='type:export_entities AND kind:MyKind'
