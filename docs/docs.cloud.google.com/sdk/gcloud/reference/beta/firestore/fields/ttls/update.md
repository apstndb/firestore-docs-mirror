---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/fields/ttls/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/fields/ttls/update
title: gcloud beta firestore fields ttls update
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2026-04-28T18:46:31Z"
---
...
`gcloud beta firestore fields ttls update` ( `  FIELD  ` : `  --collection-group  ` = `  COLLECTION_GROUP  ` `  --database  ` = `  DATABASE  ` ) ( `  --disable-ttl  ` | \[ `  --enable-ttl  ` : `  --expiration-offset  ` = `  EXPIRATION_OFFSET  ` \]) \[ `  --async  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
The following command sets the `expiry` field of the `Events` collection group (kind) to be the TTL field, with an expiration offset of one week:
    ...
    gcloud beta firestore fields ttls update expiry --collection-group=Events --enable-ttl --expiration-offset=7d
