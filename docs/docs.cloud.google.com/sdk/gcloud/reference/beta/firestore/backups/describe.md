---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/backups/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/backups/describe
title: gcloud beta firestore backups describe
...
gcloud beta firestore backups describe - retrieves information about a Cloud Firestore backup

SYNOPSIS

`gcloud beta firestore backups describe` `  --backup  ` = `  BACKUP  ` `  --location  ` = `  LOCATION  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
