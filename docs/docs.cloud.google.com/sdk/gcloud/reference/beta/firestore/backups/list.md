---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/backups/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/backups/list
title: gcloud beta firestore backups list
...
gcloud beta firestore backups list - list backups available to Cloud Firestore

SYNOPSIS

`gcloud beta firestore backups list` \[ `  --location  ` = `  LOCATION  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
