---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/databases/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/databases/update
title: gcloud beta firestore databases update
...
`gcloud beta firestore databases update` \[ `  --async  ` \] \[ `  --concurrency-mode  ` = `  CONCURRENCY_MODE  ` \] \[ `  --database  ` = `  DATABASE  ` \] \[ `  --delete-protection  ` \] \[ `  --enable-pitr  ` \] \[ `  --type  ` = `  TYPE  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
