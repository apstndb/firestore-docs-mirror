---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/user-creds/enable
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/user-creds/enable
title: gcloud beta firestore user-creds enable
...
`gcloud beta firestore user-creds enable` `  USER_CREDS  ` `  --database  ` = `  DATABASE  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]

EXAMPLES

To enable user creds 'test-user-creds-id' under database testdb.

    gcloud beta firestore user-creds enable test-user-creds-id --database='testdb'
