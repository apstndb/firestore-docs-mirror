---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/user-creds/disable
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/user-creds/disable
...
gcloud beta firestore user-creds disable - disables a Cloud Firestore user creds

SYNOPSIS

`gcloud beta firestore user-creds disable` `  USER_CREDS  ` `  --database  ` = `  DATABASE  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
