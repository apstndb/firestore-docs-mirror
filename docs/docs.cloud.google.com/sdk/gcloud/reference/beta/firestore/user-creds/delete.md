---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/user-creds/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/user-creds/delete
title: gcloud beta firestore user-creds delete
...
gcloud beta firestore user-creds delete - deletes a Cloud Firestore user creds
...
To delete user creds 'test-user-creds-id' under database testdb.
    ...
    gcloud beta firestore user-creds delete test-user-creds-id --database='testdb'
