---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/indexes/composite/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/indexes/composite/describe
title: gcloud beta firestore indexes composite describe
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2025-10-17T21:28:18Z"
---
...
`gcloud beta firestore indexes composite describe` ( `  INDEX  ` : `  --database  ` = `  DATABASE  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
