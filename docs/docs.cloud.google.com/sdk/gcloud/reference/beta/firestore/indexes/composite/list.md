---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/indexes/composite/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/firestore/indexes/composite/list
title: gcloud beta firestore indexes composite list
...
gcloud beta firestore indexes composite list - list composite indexes

SYNOPSIS

`gcloud beta firestore indexes composite list` \[ `  --database  ` = `  DATABASE  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
