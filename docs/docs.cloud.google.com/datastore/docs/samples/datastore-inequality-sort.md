---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-inequality-sort
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-inequality-sort
title: Inequality sort
