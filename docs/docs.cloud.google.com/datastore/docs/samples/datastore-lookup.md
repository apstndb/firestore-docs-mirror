---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-lookup
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-lookup
title: Lookup
description: Looks up a single entity.
