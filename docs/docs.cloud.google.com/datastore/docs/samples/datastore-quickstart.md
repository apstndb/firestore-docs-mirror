---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-quickstart
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-quickstart
title: Quickstart
