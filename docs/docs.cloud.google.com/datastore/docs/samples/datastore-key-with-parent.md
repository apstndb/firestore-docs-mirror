---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-key-with-parent
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-key-with-parent
title: Key with single parent
description: Make a key with a single parent.
