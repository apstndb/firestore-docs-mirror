---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-example-1
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-example-1
