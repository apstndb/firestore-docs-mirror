---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-admin-entities-import
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-admin-entities-import
title: Import admin entities to Datastore
description: Import admin entities to Datastore
