---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-named-key
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-named-key
title: Named key
