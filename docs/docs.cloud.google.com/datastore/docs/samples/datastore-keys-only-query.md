---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-keys-only-query
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-keys-only-query
title: Keys only query
description: Use a keys-only query.
