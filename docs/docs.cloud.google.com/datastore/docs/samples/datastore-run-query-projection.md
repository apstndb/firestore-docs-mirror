---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-run-query-projection
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-run-query-projection
title: Run projection query
description: Run a projection query.
