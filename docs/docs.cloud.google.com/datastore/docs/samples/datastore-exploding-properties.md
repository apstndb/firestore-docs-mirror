---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-exploding-properties
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-exploding-properties
title: Exploding indexes
description: Use exploding indexes.
