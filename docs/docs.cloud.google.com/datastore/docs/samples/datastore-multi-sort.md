---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-multi-sort
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-multi-sort
title: Multiple sort
description: Use multiple sort criteria.
