---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-delete-entity
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-delete-entity
title: Delete task
