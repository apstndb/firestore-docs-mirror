---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-property-run-query
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-property-run-query
title: Property query
description: Use a property query
