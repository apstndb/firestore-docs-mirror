---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-eventual-consistent-query
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-eventual-consistent-query
title: Eventual consistent query read policy
description: Use a read policy.
