---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-projection-query
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-projection-query
title: Projection query
description: Use a projection query.
