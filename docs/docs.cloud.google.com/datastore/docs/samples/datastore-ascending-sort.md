---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-ascending-sort
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-ascending-sort
