---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-kindless-query
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-kindless-query
title: Kindless query
description: Use a kindless query.
