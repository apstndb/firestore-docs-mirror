---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-array-value
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-array-value
title: Array value types
description: Set array value types.
