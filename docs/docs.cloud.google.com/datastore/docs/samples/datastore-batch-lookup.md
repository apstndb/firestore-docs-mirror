---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-batch-lookup
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-batch-lookup
title: Batch lookup
