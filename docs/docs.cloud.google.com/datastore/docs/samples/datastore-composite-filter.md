---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-composite-filter
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-composite-filter
title: Composite filter
description: Use a composite filter.
