---
name: documents/docs.cloud.google.com/datastore/docs/samples/datastore-namespace-run-query
uri: https://docs.cloud.google.com/datastore/docs/samples/datastore-namespace-run-query
