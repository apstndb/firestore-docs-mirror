---
name: documents/docs.cloud.google.com/datastore/docs/multiple-range-fields
uri: https://docs.cloud.google.com/datastore/docs/multiple-range-fields
...
For detailed information, see the [Pricing](https://docs.cloud.google.com/datastore/docs/pricing) page.
