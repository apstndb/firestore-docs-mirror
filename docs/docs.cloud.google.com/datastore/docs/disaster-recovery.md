---
name: documents/docs.cloud.google.com/datastore/docs/disaster-recovery
uri: https://docs.cloud.google.com/datastore/docs/disaster-recovery
...
To protect against potential cloud infrastructure disruptions in Google Cloud such as a zone or region experiencing an outage, Datastore mode replicates data across multiple replica databases.
...
Datastore mode automatically handles replication for you and doesn't require additional configuration or provisioning. For additional information, see the following:
