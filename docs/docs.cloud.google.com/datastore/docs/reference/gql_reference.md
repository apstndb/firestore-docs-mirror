...
<tr class="even">
<td>The operator <code dir="ltr" translate="no">=</code> functions like the <a href="https://docs.cloud.google.com/datastore/docs/reference/gql_reference#operators_and_comparisons">IN or CONTAINS</a> operators, which can yield some surprising results, especially when used with multi-valued properties.</td>
