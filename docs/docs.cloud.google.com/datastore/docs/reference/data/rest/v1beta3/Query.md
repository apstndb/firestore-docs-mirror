  ...
  - [KindExpression](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#KindExpression)
      - [JSON representation](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#KindExpression.SCHEMA_REPRESENTATION)
  - [Filter](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#Filter)
      - [JSON representation](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#Filter.SCHEMA_REPRESENTATION)
  - [CompositeFilter](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#CompositeFilter)
      - [JSON representation](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#CompositeFilter.SCHEMA_REPRESENTATION)
  - [Operator](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#Operator)
  - [PropertyFilter](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#PropertyFilter)
      - [JSON representation](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#PropertyFilter.SCHEMA_REPRESENTATION)
  - [Operator](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#Operator_1)
  - [PropertyOrder](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#PropertyOrder)
      - [JSON representation](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#PropertyOrder.SCHEMA_REPRESENTATION)
  - [Direction](https://docs.cloud.google.com/datastore/docs/reference/data/rest/v1beta3/Query#Direction)
