...
Before you read this page, you should be familiar with the [overview of Key Visualizer](/firestore/docs/key-visualizer) . You may also want to:
...
## What's next
  ...
  - Learn to recognize [entity key patterns](./keyvis-patterns) or [index key patterns](./keyvis-patterns-index) .
