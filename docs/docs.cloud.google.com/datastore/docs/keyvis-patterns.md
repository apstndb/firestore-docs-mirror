---
name: documents/docs.cloud.google.com/datastore/docs/keyvis-patterns
uri: https://docs.cloud.google.com/datastore/docs/keyvis-patterns
title: Heatmap patterns for entity keys
