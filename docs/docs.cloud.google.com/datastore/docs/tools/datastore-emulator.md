...
By running your application using the emulator, you can generate indexes for your production Datastore mode database, as well as delete unneeded indexes. Learn more at [Using the gcloud CLI](https://docs.cloud.google.com/datastore/docs/tools) .
