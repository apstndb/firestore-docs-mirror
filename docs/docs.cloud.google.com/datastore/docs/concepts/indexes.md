---
name: documents/docs.cloud.google.com/datastore/docs/concepts/indexes
uri: https://docs.cloud.google.com/datastore/docs/concepts/indexes
title: Indexes
...
An index is defined on a list of properties of a given [entity kind](https://docs.cloud.google.com/datastore/docs/concepts/entities#kinds_and_identifiers) , with a corresponding order (ascending or descending) for each property. For use with [ancestor queries](https://docs.cloud.google.com/datastore/docs/concepts/queries#ancestor_queries) , the index may also optionally include an entity's ancestors.
...
Indexes contribute to your storage costs. [Index entry size](https://docs.cloud.google.com/datastore/docs/concepts/storage-size#index_entry_size) describes how built-in and composite indexes contribute to your database's storage size. You can use [Firestore in Datastore mode statistics](https://docs.cloud.google.com/datastore/docs/concepts/stats) to see more information about index entries and index storage size.
...
You can reduce storage costs and improve write performance by [deleting unused indexes](https://docs.cloud.google.com/datastore/docs/tools/indexconfig#Datastore_Deleting_unused_indexes) and [excluding properties from indexing](https://docs.cloud.google.com/datastore/docs/concepts/indexes#unindexed_properties) . This also prevents operations from failing due to [index limits](https://docs.cloud.google.com/datastore/docs/concepts/indexes#index_limits) .
