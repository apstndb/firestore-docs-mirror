...
Transactions can query or lookup any number of entities. The maximum size of a transaction is [10 MiB](https://docs.cloud.google.com/datastore/docs/concepts/limits) . You can use a read-write transaction or a read-only transaction.
