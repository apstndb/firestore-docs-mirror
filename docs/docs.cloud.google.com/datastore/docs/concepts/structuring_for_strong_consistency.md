---
name: documents/docs.cloud.google.com/datastore/docs/concepts/structuring_for_strong_consistency
uri: https://docs.cloud.google.com/datastore/docs/concepts/structuring_for_strong_consistency
title: Structuring Data for Strong Consistency
...
Queries return their results with different levels of consistency guarantee, depending on the nature of the query:
  ...
  - [Ancestor queries](https://docs.cloud.google.com/datastore/docs/concepts/queries#ancestor_queries) (those that execute against an [entity group](https://docs.cloud.google.com/datastore/docs/concepts/entities#entity_groups) ) are strongly consistent by default, but can be made eventually consistent by setting the Datastore read policy (discussed below).
...
Datastore commits are either *transactional* , meaning they take place in the context of a [transaction](https://docs.cloud.google.com/datastore/docs/concepts/transactions) and the transaction’s set of mutations are either all applied or none are applied, or *non-transactional* , meaning the set of mutations may not apply as all or none.
