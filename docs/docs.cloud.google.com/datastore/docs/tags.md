...
To attach tags to Datastore databases, you need the [Datastore Owner](https://docs.cloud.google.com/datastore/docs/access/iam#iam_roles) role ( `roles/datastore.owner` ).
