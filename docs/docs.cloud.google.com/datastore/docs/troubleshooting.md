...
<tbody>
<tr class="odd">
<td>Sustained traffic exceeding the <a href="https://docs.cloud.google.com/datastore/docs/best-practices#ramping_up_traffic">500-50-5 rule</a> .</td>
<td>read, write</td>
...
<p>Hot-spots (high read, write, and delete rates to a narrow entity range) limit the ability of Datastore mode to scale. Review <a href="https://docs.cloud.google.com/datastore/docs/best-practices#designing_for_scale">designing for scale</a> and identify hot-spots in your application.</p></td>
</tr>
<tr class="even">
...
<p>Review <a href="https://docs.cloud.google.com/datastore/docs/concepts/transactions#isolation_and_consistency">transaction isolation and consistency</a> and how you use transactions.</p></td>
</tr>
<tr class="odd">
...
<td>read</td>
<td>Use <a href="https://docs.cloud.google.com/datastore/docs/concepts/queries#cursors_limits_and_offsets">query cursors</a> to split large reads.</td>
</tr>
<tr class="odd">
...
<td>write</td>
<td>Review <a href="https://docs.cloud.google.com/datastore/docs/concepts/indexes#exploding_index">exploding indexes</a> and your usage of array properties.</td>
</tr>
</tbody>
</table>
