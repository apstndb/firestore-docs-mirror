...
For more information about how to improve your disaster recovery plan, see [Plan disaster recovery](https://docs.cloud.google.com/datastore/docs/disaster-recovery) .
