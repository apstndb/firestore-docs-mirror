---
name: documents/docs.cloud.google.com/datastore/docs/console/managing-datastore
uri: https://docs.cloud.google.com/datastore/docs/console/managing-datastore
title: Managing Firestore in Datastore mode from the Console
