---
name: documents/docs.cloud.google.com/datastore/docs/backups
uri: https://docs.cloud.google.com/datastore/docs/backups
title: Back up and restore data
description: A highly-scalable NoSQL database for your web and mobile applications that automatically handles sharding and replication.
data_source: docs.cloud.google.com
---

This page describes how to use the Datastore mode scheduled backups feature. Use backups to protect your data from application-level data corruption or from accidental data deletion.
...
A restore operation writes the data from a backup to a new Datastore mode database.
