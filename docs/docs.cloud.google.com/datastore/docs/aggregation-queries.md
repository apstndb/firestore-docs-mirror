---
name: documents/docs.cloud.google.com/datastore/docs/aggregation-queries
uri: https://docs.cloud.google.com/datastore/docs/aggregation-queries
...
## What's next
  ...
  - Learn about [best practices for Firestore in Datastore mode](https://docs.cloud.google.com/datastore/docs/best-practices) .
